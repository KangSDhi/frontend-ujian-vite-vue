<template>
    <div class="flex justify-center items-center absolute z-50 top-0 right-0 bottom-0 left-0">
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            <button type="button" @click="deleteDialogSoalClose"
            ...
            <div class="p-4 md:p-5 text-center">
                ...
                <h3 class="mb-2 text-lg font-normal text-gray-500 dark:text-gray-400">
                    Apakah Anda Ingin Menghapus Data Soal ?
                </h3>
                <h4 class="mb-2 text-md font-normal text-gray-600 dark:text-gray-300">{{ questionDataDelete.namaSoal }}</h4>
