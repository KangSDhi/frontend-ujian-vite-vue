        ...
        <div class="z-50 bg-white dark:bg-gray-900 px-16 py-14 rounded-md">
            ...
            <div class="grid md:grid-cols-2 gap-1">
                ...
                <div>
                    ...
                    <select id="input-question-level" v-model="questionDataEdit.tingkat"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                ...
                <div>
                    ...
                    <select id="input-question-study-program" v-model="questionDataEdit.jurusan"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                ...
                <div>
                    ...
                    <span class="text-red-500 text-sm font-bold">{{ errorUpdateQuestion.questionShuffleErrorMessage
                        }}</span>
                </div>
                <div>
                ...
                <div>
                    ...
                    <span class="text-red-500 text-sm font-bold">{{ errorUpdateQuestion.questionTypeErrorMessage
                        }}</span>
                </div>
                <div>
                ...
                <div>
                    ...
                    <input id="input-question-duration" type="text" pattern="^([01]\d|2[0-3]):[0-5]\d:[0-5]\d$"
                        ...
                        required>
                    <span class="text-red-500 text-sm font-bold">{{ errorUpdateQuestion.questionDurationErrorMessage
                        }}</span>
                </div>
            </div>
            <div class="flex mt-3 justify-end gap-2">
                ...
                <button @click="formToEditQuestionClose"
...
export default {
    ...
    methods: {
        ...
        formToEditQuestionClose(){
            this.resetErrorForm();
            this.$emit('isFormToEditQuestionFalse', false);
        },
        formatDate(value) {
        ...
        resetErrorForm(){
            this.errorUpdateQuestion.questionNameErrorMessage = "";
            this.errorUpdateQuestion.questionShuffleErrorMessage = "";
            this.errorUpdateQuestion.questionItemErrorMessage = "";
            this.errorUpdateQuestion.questionDurationErrorMessage = "";
            this.errorUpdateQuestion.questionStudyProgramErrorMessage = "";
            this.errorUpdateQuestion.questionLevelErrorMessage = "";
            this.errorUpdateQuestion.questionTypeErrorMessage = "";
            this.errorUpdateQuestion.questionStartTimeErrorMessage = "";
            this.errorUpdateQuestion.questionEndTimeErrorMessage = "";
        }
    }
}
</script>