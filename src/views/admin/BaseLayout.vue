    ...
    <div>
        <section>
            ...
            <aside class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform" :class="sidebarComputed">
                <div class="h-full px-3 py-4 bg-gray-100 dark:bg-gray-800">
                    <a href="#" class="flex items-center pl-2.5 mb-5">
                        <img src="/logo.webp" class="h-5 mr-3 sm:h-7" alt="Ujian Logo" />
                    ...
                    <ul>
                        <li>
                            <RouterLink :to="{ name: 'Dashboard Admin Page' }"
                        ...
                        <li>
                            <RouterLink :to="{ name: 'Level And Study Programs Management Page' }"
                                class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                                ...
                                <span class="ml-3">Data Tingkat & Jurusan</span>
                            </RouterLink>
                        </li>
                        <li>
                            <a href="#"
                        ...
                        <li>
                            <RouterLink :to="{ name: 'Question Management Admin Page' }"
                                class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <li>
                            <a href="#"
                                ...
                                <span class="ml-3">Data Ujian</span>
                            </a>
                        </li>
                        <li>
                            <a @click="isLogoutDialogOpen = true, isSidebarOpen = false"
                                class="flex items-center mt-2 p-2 text-gray-900 rounded-lg bg-red-500 dark:text-white hover:bg-red-600 dark:hover:bg-red-600 group cursor-pointer">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                    <path stroke-linecap="round" stroke-linejoin="round"
